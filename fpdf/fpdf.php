...
public function _httpencode($param, $value, $isUTF8)
{
...
public function _putstream($data)
{
	$this->_put('stream');
	$this->_put($data);
	$this->_put('endstream');
...
public function _putstreamobject($data)
{
	if($this->compress)
	{
...
public function _tounicodecmap($uv)
{
	$ranges = '';
	$nbr = 0;
	$chars = '';
